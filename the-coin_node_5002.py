...
# Part 1 - Build Cryptocurrency (based on the Blockchain)
class Blockchain:
...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'Miguelito', amount = 10)
...
def is_valid():
    ...
    if is_valid:
        ...
        response = {'message': 'uh oh! is NOT valid'}
    return jsonify(response), 200
